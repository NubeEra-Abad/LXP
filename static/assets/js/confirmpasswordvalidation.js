(function ($) {
	...
	if ($('#cpasswordInput').length > 0) {
		let passwordInput = document.querySelector('#cpasswordInput input[type="password"]');
		let passwordStrength = document.getElementById('cpasswordStrength');
		let poor = document.querySelector('#cpasswordStrength #poor');
		let weak = document.querySelector('#cpasswordStrength #weak');
		let strong = document.querySelector('#cpasswordStrength #strong');
		let heavy = document.querySelector('#cpasswordStrength #heavy');
		let passwordInfo = document.getElementById('cpasswordInfo');
		let passcheck = document.querySelector('#cpasswordInput .cpass-checked');
		...
		function poorPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword) {
			if (passwordLength < 8) {
				...
				passwordInfo.innerHTML = '<img src="/static/assets/img/icon/angry.svg" class="me-2">' + "Weak. Must contain at least 8 characters";
		...
		function strongPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword) {
			if (passwordLength >= 8 && poorPassword && (weakPassword || strongPassword)) {
				...
				passwordStrength.classList.remove("heavy-active");
				passwordInfo.innerHTML = '<img src="/static/assets/img/icon/chart.svg" class="me-2">' + "Almost. Must contain special symbol";
		...
		function heavyPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword) {
			if (passwordLength >= 8 && (poorPassword && weakPassword) && strongPassword) {
				...
				passwordInfo.innerHTML = '<img src="/static/assets/img/icon/smile.svg" class="me-2">' + "Awesome! You have a secure password.";
	...
	if ($('#cpasswordInputs').length > 0) {

		let passwordInput1 = document.querySelector('#cpasswordInputs input[type="password"]');
		let passwordStrength1 = document.getElementById('cpasswordStrengths');
		let poor1 = document.querySelector('#cpasswordStrengths #poors');
		let weak1 = document.querySelector('#cpasswordStrengths #weaks');
		let strong1 = document.querySelector('#cpasswordStrengths #strongs');
		let heavy1 = document.querySelector('#cpasswordStrengths #heavys');
		let passwordInfos = document.getElementById('cpasswordInfos');
		let passcheck1 = document.querySelector('#cpasswordInputs .cpass-checked');
		...
		function poor1Password1Strength1(passwordLength1, poor1Password1, weak1Password1, strong1Password1) {
			if (passwordLength1 < 8) {
				...
				passwordInfos.innerHTML = '<img src="/static/assets/img/icon/angry.svg" class="me-2">' + "weak1. Must contain at least 8 characters";
		...
		function weak1Password1Strength1(passwordLength1, poor1Password1, weak1Password1, strong1Password1) {
			if (passwordLength1 >= 8 && (poor1Password1 || weak1Password1 || strong1Password1)) {
				...
				passwordInfos.innerHTML = '<img src="/static/assets/img/icon/anguish.svg" class="me-2">' + "Average. Must contain at least 1 letter or number";
		...
		function strong1Password1Strength1(passwordLength1, poor1Password1, weak1Password1, strong1Password1) {
			if (passwordLength1 >= 8 && poor1Password1 && (weak1Password1 || strong1Password1)) {
				...
				passwordStrength1.classList.remove("heavy-active");
				passwordInfos.innerHTML = '<img src="/static/assets/img/icon/smile.svg" class="me-2">' + "Almost. Must contain special symbol";
		...
		function heavy1passwordStrength1(passwordLength1, poor1Password1, weak1Password1, strong1Password1) {
			if (passwordLength1 >= 8 && (poor1Password1 && weak1Password1) && strong1Password1) {
				...
				passwordInfos.innerHTML = '<img src="/static/assets/img/icon/smile.svg" class="me-2">' + "Awesome! You have a secure password.";
