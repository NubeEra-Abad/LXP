    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(db_index=True, default=datetime.datetime(2023, 4, 3, 22, 5, 27, 957796))),
            ],
            options={
        ...
        migrations.AddField(
            model_name='code',
            name='timestamp',
            field=models.DateTimeField(db_index=True, default=datetime.datetime(2023, 4, 3, 22, 5, 27, 957796)),
        ),
        migrations.AddField(
            model_name='usersocialauth',
            name='created',
            field=models.DateTimeField(default=datetime.datetime(2023, 4, 3, 22, 5, 27, 955798)),
        ),
        migrations.AddField(
            model_name='usersocialauth',
            name='modified',
