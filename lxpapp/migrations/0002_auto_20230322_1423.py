# Generated by Django 3.0.14 on 2023-03-22 08:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desciption', models.CharField(default='', max_length=1000)),
                ...
                ('mainhead', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lxpapp.MainHead')),
                ('subhead', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lxpapp.SubHead')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('batch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lxpapp.Batch')),
                ('courseset', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lxpapp.CourseSet')),
            ],
        ),
        migrations.AddField(
            model_name='batch',
