...
urlpatterns = [
    ...
    path('exam-random-mcqquestions/', RandomMcqQuestionsView.as_view(), name='api-exam-random-mcqquestions'),
    path('exam-random-short-questions/', RandomShortQuestionsView.as_view(), name='api-exam-random-short-questions'),
